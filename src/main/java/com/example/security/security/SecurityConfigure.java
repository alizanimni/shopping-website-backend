    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/users/**","/cart/**","/items/add-to-favorite/**").authenticated() // All authenticated users can access these routes
        ...
        http.headers(headers -> headers.frameOptions(frameOptions -> frameOptions.sameOrigin())); // Allow same-origin frames
        return http.build();
    }
